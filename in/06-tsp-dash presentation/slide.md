...
- Кто может пользоваться дашбордом — только наша команда или коллеги из других подразделений?
- Нужен ли отдельный сервер, или каждый ставит себе на рабочий ПК?
- Что нужно для первого запуска — только доступ к `Z:\` или ещё что-то?

**Данные**

- Как часто обновляются цифры — каждый день автоматически или нужно что-то нажимать?
- Можно ли смотреть историю за прошлые месяцы или только «свежие» данные?
- Откуда берутся ошибки — это те же отчёты, что приходят на почту?
