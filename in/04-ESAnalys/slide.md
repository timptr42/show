...
- **Нейронки** — Codex, Qwen 3.6 (локальный, доступный в контуре ЦПЛ)
- **Инструмент разработки** - Visual Studio Code (плагин Roo Code)
- **Язык програмирования** - Python 3.12
- **Компоненты** - fastapi, uvicorn, elasticsearch, httpx
...
![Пример текущего процесса поиска](demo-04.png)

![Пример текущего процесса поиска](demo-05.png)

![Пример текущего процесса поиска](demo-06.png)

![Поиск по идентификатору в интерфейсе](demo-01.gif)

![Цепочка запросов и ответов](demo-02.png)

![Отображение остальной части логов](demo-03.png)
