...
- Какие поля из `summary` должны стать обязательными для автоматических проверок?
- Нужен ли отдельный набор правил для разных контуров или партнёров?
- Что считать успешным результатом: отсутствие ошибок, полный набор request/response или конкретный статус операции?
- Кто будет обновлять правила распознавания, если в Purchase API появятся новые методы?
